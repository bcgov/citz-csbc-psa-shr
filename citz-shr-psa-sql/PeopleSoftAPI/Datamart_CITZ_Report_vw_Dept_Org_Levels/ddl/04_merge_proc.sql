...
BEGIN
    ...
    BEGIN TRY
        ...
        OUTPUT
            ...
            CAST(deleted.Level1Key     AS NVARCHAR(255)) AS OldLevel1Key,
            CAST(deleted.Level2        AS NVARCHAR(255)) AS OldLevel2,
            CAST(deleted.Level2Key     AS NVARCHAR(255)) AS OldLevel2Key,
            CAST(deleted.Level3        AS NVARCHAR(255)) AS OldLevel3,
            CAST(deleted.Level3Key     AS NVARCHAR(255)) AS OldLevel3Key,
            CAST(deleted.Level4        AS NVARCHAR(255)) AS OldLevel4,
            CAST(deleted.Level4Key     AS NVARCHAR(255)) AS OldLevel4Key,
            CAST(deleted.Level5        AS NVARCHAR(255)) AS OldLevel5,
            CAST(deleted.Level5Key     AS NVARCHAR(255)) AS OldLevel5Key,
            CAST(deleted.Organization  AS NVARCHAR(255)) AS OldOrganization,

            CAST(inserted.Level1       AS NVARCHAR(255)) AS NewLevel1,
            CAST(inserted.Level1Key    AS NVARCHAR(255)) AS NewLevel1Key,
            CAST(inserted.Level2       AS NVARCHAR(255)) AS NewLevel2,
            CAST(inserted.Level2Key    AS NVARCHAR(255)) AS NewLevel2Key,
            CAST(inserted.Level3       AS NVARCHAR(255)) AS NewLevel3,
            CAST(inserted.Level3Key    AS NVARCHAR(255)) AS NewLevel3Key,
            CAST(inserted.Level4       AS NVARCHAR(255)) AS NewLevel4,
            CAST(inserted.Level4Key    AS NVARCHAR(255)) AS NewLevel4Key,
            CAST(inserted.Level5       AS NVARCHAR(255)) AS NewLevel5,
            CAST(inserted.Level5Key    AS NVARCHAR(255)) AS NewLevel5Key,
