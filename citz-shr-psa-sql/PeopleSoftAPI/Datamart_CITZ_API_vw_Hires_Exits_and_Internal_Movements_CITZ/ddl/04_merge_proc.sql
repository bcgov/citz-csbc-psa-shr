...
BEGIN
    ...
    BEGIN TRY
        ...
        OUTPUT
            ...
            inserted.IsActive,
            -- header Old/New
            deleted.CompChange,               inserted.CompChange,
            deleted.MoveType,                 inserted.MoveType,
            deleted.MoveType1,                inserted.MoveType1,
            deleted.MoveType2,                inserted.MoveType2,
            deleted.FiscalYear,               inserted.FiscalYear,
            deleted.Name,                     inserted.Name,
            -- New-state key cols Old/New
            deleted.NewAction,                inserted.NewAction,
            deleted.NewActionReasonDescr,     inserted.NewActionReasonDescr,
            deleted.NewEmplStatus,            inserted.NewEmplStatus,
            deleted.NewEmplCtg,               inserted.NewEmplCtg,
            deleted.NewDeptId,                inserted.NewDeptId,
            deleted.NewDeptIdDescr,           inserted.NewDeptIdDescr,
            deleted.NewLevel1,                inserted.NewLevel1,
            deleted.NewLevel2,                inserted.NewLevel2,
            deleted.NewOrganization,          inserted.NewOrganization,
            deleted.NewSalAdminPlan,          inserted.NewSalAdminPlan,
            deleted.NewGrade,                 inserted.NewGrade,
            deleted.NewStep,                  inserted.NewStep,
            deleted.NewAnnualRt,              inserted.NewAnnualRt,
            deleted.NewPositionNbr,           inserted.NewPositionNbr,
            deleted.NewSupervisor,            inserted.NewSupervisor,
            -- Prior-state key cols Old/New
            deleted.PriorAction,              inserted.PriorAction,
            deleted.PriorEmplStatus,          inserted.PriorEmplStatus,
            deleted.PriorEmplCtg,             inserted.PriorEmplCtg,
            deleted.PriorDeptId,              inserted.PriorDeptId,
            deleted.PriorDeptIdDescr,         inserted.PriorDeptIdDescr,
            deleted.PriorLevel1,              inserted.PriorLevel1,
            deleted.PriorOrganization,        inserted.PriorOrganization,
            deleted.PriorSalAdminPlan,        inserted.PriorSalAdminPlan,
            deleted.PriorGrade,               inserted.PriorGrade,
            deleted.PriorStep,                inserted.PriorStep,
            deleted.PriorAnnualRt,            inserted.PriorAnnualRt
