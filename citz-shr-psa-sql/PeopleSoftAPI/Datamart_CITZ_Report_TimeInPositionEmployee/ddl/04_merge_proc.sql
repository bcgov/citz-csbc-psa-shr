...
BEGIN
    ...
    OUTPUT
        ...
        CAST(DELETED.DaysInPosition              AS NVARCHAR(255)), CAST(INSERTED.DaysInPosition              AS NVARCHAR(255)),
        CAST(DELETED.YearsInPosition             AS NVARCHAR(255)), CAST(INSERTED.YearsInPosition             AS NVARCHAR(255)),
        CONVERT(NVARCHAR(255), DELETED.ExitDate, 23),               CONVERT(NVARCHAR(255), INSERTED.ExitDate, 23),
        CAST(DELETED.ExitAction                  AS NVARCHAR(255)), CAST(INSERTED.ExitAction                  AS NVARCHAR(255)),
        CAST(DELETED.ExitReason                  AS NVARCHAR(255)), CAST(INSERTED.ExitReason                  AS NVARCHAR(255)),
        CAST(DELETED.ExitReasonDescr             AS NVARCHAR(255)), CAST(INSERTED.ExitReasonDescr             AS NVARCHAR(255)),
        CAST(DELETED.Organization                AS NVARCHAR(255)), CAST(INSERTED.Organization                AS NVARCHAR(255)),
        CAST(DELETED.Level1                      AS NVARCHAR(255)), CAST(INSERTED.Level1                      AS NVARCHAR(255)),
        CAST(DELETED.Level2                      AS NVARCHAR(255)), CAST(INSERTED.Level2                      AS NVARCHAR(255)),
        CAST(DELETED.DeptId                      AS NVARCHAR(255)), CAST(INSERTED.DeptId                      AS NVARCHAR(255)),
        CAST(DELETED.ClassificationGroupAtEntry  AS NVARCHAR(255)), CAST(INSERTED.ClassificationGroupAtEntry  AS NVARCHAR(255)),
        CAST(DELETED.JobCodeAtEntry              AS NVARCHAR(255)), CAST(INSERTED.JobCodeAtEntry              AS NVARCHAR(255)),
        CAST(DELETED.CurrentOrHistorical         AS NVARCHAR(255)), CAST(INSERTED.CurrentOrHistorical         AS NVARCHAR(255)),
        CAST(DELETED.CurrentStatus               AS NVARCHAR(255)), CAST(INSERTED.CurrentStatus               AS NVARCHAR(255)),
        CAST(DELETED.CurrentOrganization         AS NVARCHAR(255)), CAST(INSERTED.CurrentOrganization         AS NVARCHAR(255)),
        CAST(DELETED.CurrentDeptId               AS NVARCHAR(255)), CAST(INSERTED.CurrentDeptId               AS NVARCHAR(255))
