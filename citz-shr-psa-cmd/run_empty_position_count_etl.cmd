@echo off
REM ============================================================================
REM Task Scheduler wrapper for psa_empty_position_count_etl.R
REM
...
set LOGFILE=%LOGDIR%\psa_empty_position_count_etl.log
...
"E:\R\R-4.4.3\bin\Rscript.exe" --vanilla "%BASEDIR%\citz-shr-psa-r\psa_empty_position_count_etl.R" >> "%LOGFILE%" 2>&1
